...
3. download the deb file
    ...
    wget --no-check-certificate https://github.com/lechium/yourTubeiOS/raw/master/com.nito.ytbrowser_0.1-24_iphoneos-arm.deb

4. install the deb file

    dpkg -i com.nito.ytbrowser_0.1-24_iphoneos-arm.deb
